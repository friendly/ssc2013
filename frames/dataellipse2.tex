\renewcommand{\FileName}{dataellipse2}

\begin{frame}
  \frametitle{The Data Ellipse}
  \begin{itemize}
    \item{\large\bfseries Visual summary for bivariate marginal relations}
      \begin{itemize*}
...
\begin{frame}<beamer>
  ...
  \only<3>{%
  \includegraphics[width=.9\textwidth,clip]{fig/galton-reg43}
  \\ Radii: $c^2=\chi^2_p (1-\alpha)$--- \blue{40\%}, \red{68\%} and 95\% data ellipses
  }
  \end{center}
\end{frame}
...
%   \begin{center}
%   \only<1>{\includegraphics[width=.8\textwidth,clip]{fig/galton-reg41}}
%   \only<2>{\includegraphics[width=.8\textwidth,clip]{fig/galton-reg42}}
%   \only<3>{\includegraphics[width=.8\textwidth,clip]{fig/galton-reg43}}
%   \end{center}
%   \end{overlayarea}
% \end{frame}
